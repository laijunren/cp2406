public class Car {
    ...
    private static final String CAR_ID_PREFIX = "car_";
...
//                getId(), this.getPosition());
    ...
    public String toString() {
        return String.format("%s going:%dm/s on %s at position:%s%n",
                this.getId(), this.getSpeed(), this.getCurrentRoad().getId(), this.getPosition());
    }
}
